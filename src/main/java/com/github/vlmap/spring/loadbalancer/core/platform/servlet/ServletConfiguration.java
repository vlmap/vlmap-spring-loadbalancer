...
public class ServletConfiguration {
    ...
    @Bean
    public LoadBalancerContextServletFilter loadBalancerContextServletFilter(GrayLoadBalancerProperties properties) {

        return new LoadBalancerContextServletFilter(properties);
    }
